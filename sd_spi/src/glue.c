...
DSTATUS sd_disk_status(BYTE pdrv /* Physical drive nmuber to identify the drive */
) {
    TRACE_PRINTF(">>> %s\n", __FUNCTION__);
...
DRESULT sd_disk_read(BYTE pdrv,  /* Physical drive nmuber to identify the drive */
...
DRESULT sd_disk_write(BYTE pdrv, /* Physical drive nmuber to identify the drive */
...
DRESULT sd_disk_ioctl(BYTE pdrv, /* Physical drive nmuber (0..) */
